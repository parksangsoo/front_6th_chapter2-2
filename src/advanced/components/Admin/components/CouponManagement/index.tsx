...
import { couponFormAtom, showCouponFormAtom } from "../../../../state";
...
export default function CouponManagement(props: CouponManagementProps) {
  const [showCouponForm, setShowCouponForm] = useAtom(showCouponFormAtom);
  const [couponForm, setCouponForm] = useAtom(couponFormAtom);

  const { coupons, deleteCoupon, handleCouponSubmit, addNotification } = props;
    ...
    <section className="bg-white rounded-lg border border-gray-200">
      ...
      <div className="p-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          {coupons.map(coupon => (
            <AdminCoupon coupon={coupon} deleteCoupon={deleteCoupon} />
          ))}
